...
<head>
	...
	<title>Призы за баллы</title>
	<meta name="description" content="Призы за баллы">
	...
	<meta property="og:url" content= "http://mwogame.com/points/prizes.php">
	<meta property="og:site_name" content="Metal War Online">
	<meta property="og:title" content="Призы за баллы">
	<meta property="og:description" content="Призы за баллы">
...
<div class="main">
	...
	<div id="table" class="clearfix">
		<div class="table-t">
			<div>
				<div class="spisok-priz">
					<a href="" class="add_message1" id="click_mes_form1">
						<h3 class="heding" title="Жмякни">Оборудование</h3>
					</a>
			...
			<div>
				<div class="spisok-priz">
					<a href="" class="add_message2" id="click_mes_form2">
						<h3 class="heding" title="И тут жмяк">Припасы</h3>
					</a>
					<script type="text/javascript">
						$(document).ready(function(){
					...
					<div class="tablspisok" id="popup_message_form2" style="display:block;">
						<table class="table_dark">
							<tr>
								<th colspan="2">Приз</th>
								<th >Количество</th>
			...
			<div>
				<div class="spisok-priz1">
					<a href="" class="add_message3" id="click_mes_form3">
						<h3 class="heding" title="Ещё жмяк">Премиальная техника</h3>
					</a>
					<script type="text/javascript">
						$(document).ready(function(){
					...
					<div class="tablspisok" id="popup_message_form3" style="display:block;">
						<table class="table_dark">
							<tr>
								<th colspan="2">Приз</th>
								<th >Баллы</th>
