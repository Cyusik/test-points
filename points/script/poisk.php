...
if($search == false) {
	...
	if($page > $pagesCount) {
		...
		if($page != 1) {
			...
			$perv1page = '<a href= ./index.php?page='.($page - 1).'>Назад</a>';
		}
		else {
			$pervpage = '<a href= ./index.php?page=1 class="disabled"><<</a>';
			$perv1page = '<a href= ./index.php?page= class="disabled" '.($page - 1).'>Назад</a>';
		}
		if($page != $pagesCount) {
			$nextpage1 = '<a href= ./index.php?page='.($page + 1).'>Далее</a>';
			$nextpage = '<a href= ./index.php?page='.$pagesCount.'>>></a>';
		}
		else {
			$nextpage1 = '<a href= ./index.php?page= class="disabled" '.($page + 1).'>Далее</a>';
			$nextpage = '<a href= ./index.php?page= class="disabled" '.$pagesCount.'>>></a>';
		}
		if($page - 3 > 0)
		...
		echo "<ul class='pagination'>
			<li>$pervpage</li>
			<li>$perv1page</li>".$page3left.$page2left.$page1left."<li><b>$page</b></li>".$page1right.$page2right.$page3right."<li>$nextpage1</li>
			<li>$nextpage</li>
		</ul>";
	}
}else {
