...
<div class="fon">
	...
	<div>
		<nav>
			<ul class="menu">
				<li><a href="../results" class="button15" target="_blank">Таблица итогов обмена</a></li>
			...
			<table class="table_import1">
				...
				<tr>
					<td>
						<br>
						<?php
						$query = ("SELECT COUNT(*) as count FROM itogobmen WHERE id > 0");
						$result = mysqli_query($link, $query) or die("Ошибка ".mysqli_error($link));
						if($result){
							$strokitog = $result->fetch_assoc();
							$ni = $strokitog['count'];
